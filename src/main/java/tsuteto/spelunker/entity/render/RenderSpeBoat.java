...
public class RenderSpeBoat extends RenderBoat
{
    private static final ResourceLocation texture = new ResourceLocation("spelunker", "textures/speboat.png");

    /** instance of ModelBoat for rendering */
    protected ModelBase modelBoat;

    public RenderSpeBoat()
    {
    ...
    {
        this.doRender((EntitySpeBoat)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}
