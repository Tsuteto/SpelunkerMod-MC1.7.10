...
public class RenderSpelunkerItem extends Render
{
     ...
     * Renders the item
     */
    public void doRenderItem(EntitySpelunkerItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (itemstack.getItem() != null)
        {
            ...
            if (itemstack.getItemSpriteNumber() == 0 && itemstack.getItem() instanceof ItemBlock && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(itemstack.getItem()).getRenderType()))
            {
                ...
                for (int l = 0; l < b0; ++l)
                {
                    ...
                    this.itemRenderBlocks.renderBlockAsItem(block, itemstack.getItemDamage(), 1.0F);
                    GL11.glPopMatrix();
                }
    ...
    protected ResourceLocation getEntityTexture(EntitySpelunkerItem par1EntityItem)
    {
     ...
     */
    private void renderDroppedItem(EntitySpelunkerItem par1EntityItem, IIcon par2Icon, int par3, float par4, float par5, float par6, float par7)
    {
        renderDroppedItem(par1EntityItem, par2Icon, par3, par4, par5, par6, par7, 0);
    }
    private void renderDroppedItem(EntitySpelunkerItem par1EntityItem, IIcon par2Icon, int par3, float par4, float par5, float par6, float par7, int pass)
    {
    ...
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5, boolean renderEffect)
    {
        ...
        if (par3ItemStack.getItemSpriteNumber() == 0 && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(par3ItemStack.getItem()).getRenderType()))
        {
            ...
            this.itemRenderBlocks.renderBlockAsItem(block, k, 1.0F);
    ...
    {
        return this.getEntityTexture((EntitySpelunkerItem)par1Entity);
    }
    ...
    {
        this.doRenderItem((EntitySpelunkerItem)par1Entity, par2, par4, par6, par8, par9);
    }
