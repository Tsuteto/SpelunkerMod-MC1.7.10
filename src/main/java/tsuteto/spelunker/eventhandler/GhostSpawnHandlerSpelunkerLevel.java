...
public class GhostSpawnHandlerSpelunkerLevel extends GhostSpawnHandler
{
    protected GhostSpawnHandlerSpelunkerLevel(SpelunkerPlayerMP spelunker, Random rand)
    {
    ...
    {
        // Same to the normal one for now
        for (int i = 0; i < 10; i++)
        {
