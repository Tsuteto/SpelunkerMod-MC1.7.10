...
{
    private static final ResourceLocation buttonTexture = new ResourceLocation("spelunker", "icons.png");
    ...
    public GuiIconButton(int par1, int par2, int par3, int par5, int par6)
    {
