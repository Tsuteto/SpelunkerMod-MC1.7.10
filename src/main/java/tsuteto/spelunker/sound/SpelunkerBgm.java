...
{
    public static final ModSound bgmMain = ModSound.bgm(new ResourceLocation("spelunker:main_bgm"));
    public static final ModSound bgm2xScore = ModSound.bgm(new ResourceLocation("spelunker:2xscore_bgm"));
