...
public class ItemSpeBoat extends Item implements SpelunkerWorldItem
{
    public ItemSpeBoat()
    {
        this.maxStackSize = 1;
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntitySpeBoat entityboat = new EntitySpeBoat(p_77659_2_, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
